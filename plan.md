...
| **E2** mass-outage guard | The edge pair: 23/152 = 15.13 % (guard on, nobody punished, counter neither advances nor resets) against 22/152 = 14.47 % (guard off) | **RUNNING** (`dsl-mass-outage-guard-2026-09-06`, opened 8613): `/root/dsl-outage-e2.sh` on fullnode-4, -5 and -6, scheduled by height. 22 stop at 8668 (fullnode-4 mn1-10, fullnode-5 mn1-10, fullnode-6 mn1-2), the 23rd (fullnode-6 mn3) at 8740, all start at 8808. Expected: counters 1, 2, 3 at the 8712, 8736, 8760 commits; missedCount 23 at 8784 and 8808 with the guard open (counters frozen at 3, no suspension where 4 would have suspended), clear at 8832. Close after the clear; revive the DKG-PoSe bans with a funded fee address |
