...
| **E2** mass-outage guard | The edge pair: 23/152 = 15.13 % (guard on, nobody punished, counter neither advances nor resets) against 22/152 = 14.47 % (guard off) | **ready** — E1b closed. Wait for the five revives to confirm and for two clean epochs before arming; 23 nodes down is also 23 DKG-PoSe candidates, so expect a ban wave on the DKG side and plan the revive |
