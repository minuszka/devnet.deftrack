#!/bin/bash
#
# The C2 roll (#235-#240, merged v22.1.x dc0db600e4): put the fleet artefact on
...
# its version.
#
#   usage: ./c2-fleet-stage.sh <fleet-defcond>
set -uo pipefail

EXPECT_MD5=c9898910b40a57d253dae73905e14845
DEST=/tmp/defcond-c2
KEY=/root/.ssh/defcon_nodes
INVENTORY=${FLEET_INVENTORY:-/root/fleet-nodes-all.txt}

DAEMON=${1:?usage: c2-fleet-stage.sh <fleet-defcond>}
