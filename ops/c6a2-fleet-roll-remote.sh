#!/bin/sh
#
# Runs ON ONE FLEET HOST, copied there by c6a2-fleet-roll.sh.
#
#   usage: c6a2-fleet-roll-remote.sh <staged-binary> <new-md5> <old-md5> preflight|apply
#
# The C6a end-height roll changes the binary and nothing else: no conf key. The #231 key
