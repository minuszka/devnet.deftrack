#!/bin/bash
#
# The C6a roll (#241-#243, merged v22.1.x ddf2822011): put the fleet artefact on
...
# its version.
#
#   usage: ./c6a-fleet-stage.sh <fleet-defcond>
set -uo pipefail

EXPECT_MD5=7bf411b0eb08731b6e050868b1d2ff72
DEST=/tmp/defcond-c6a
KEY=/root/.ssh/defcon_nodes
INVENTORY=${FLEET_INVENTORY:-/root/fleet-nodes-all.txt}

DAEMON=${1:?usage: c6a-fleet-stage.sh <fleet-defcond>}
